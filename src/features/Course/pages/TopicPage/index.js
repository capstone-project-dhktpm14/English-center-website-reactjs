...
import { fetchCourseDetail, fetchCourseWords } from "features/Course/CourseSlice";
import { WordList } from "features/WordNote/common";
...
function TopicPage(props) {
	...
	const { courseWords, courseDetail } = useSelector((state) => state.courseClient);
