...
import topicAdminApi from 'api/admin/topicAdminApi';
import wordAdminApi from 'api/admin/wordAdminApi';
...
export const fetchCourses = createAsyncThunk(
  ...
  async (params, thunkApi) => {
    const data = await courseAdminApi.fetchCourses(params);
    return data;
  }
);
...
export const fetchCourse = createAsyncThunk(
  `${KEY}/fetchCourse`,
  async (params, thunkApi) => {
    const data = await courseAdminApi.fetchCourse(params);
    return data;
  }
);
...
export const fetchTopics = createAsyncThunk(
  `${KEY}/fetchTopics`,
  async (params, thunkApi) => {
    const data = await topicAdminApi.fetchTopics();
...
export const deleteCourse = createAsyncThunk(
  ...
  async (params, thunkApi) => {
    ...
    await courseAdminApi.deleteCourse(courseId);
    return courseId;
  }
);
...
export const deleteTopic = createAsyncThunk(
  ...
  async (params, thunkApi) => {
    ...
    await topicAdminApi.deleteTopic(topicId);
    return topicId;
  }
);
...
export const fetchWordsByCourse = createAsyncThunk(
  ...
  async (params, thunkApi) => {
    const data = await wordAdminApi.fetchWordsByCourse(params);
    return data;
  }
);
...
export const deleteWord = createAsyncThunk(
  ...
  async (params, thunkApi) => {
    const { wordId } = params;
    await wordAdminApi.deleteWord(wordId);
    return wordId;
  }
);
